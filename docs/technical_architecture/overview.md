...
This document provides an overview of the technical architecture and serves as a navigation guide to the detailed technical documentation.
...
- **[../shared/data_models.md](../shared/data_models.md)** - Chunk object schema and data contracts
- **[../shared/storage_interface.md](../shared/storage_interface.md)** - Storage layer interface
- **[../shared/glossary.md](../shared/glossary.md)** - Terms and definitions

## Key Technical Decisions

_To be documented as the system is designed..._
